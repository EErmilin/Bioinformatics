...
map<char, int> MassOfAminoAcid{ { 'G', 57 },{ 'A', 71 },{ 'S', 87 },{ 'P', 97 },{ 'V', 99 },
...
{
	string res = "";
	list<string> subpeptidesOfPeptide;
	list<int> weightSubpeptidesOfPeptide;
	string tmp;
	int weight = 0;
...
{
	string res = "";
	list<std::string> subpeptidesOfPeptide;
	string tmp;
	int weight = 0;
	for (int i = 1; i < aminoAcid.length(); i++) {
		for (int j = 0; j < aminoAcid.length(); j++) {
